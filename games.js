games =  [
    ...
    },
    {
        ...
        "review_2": "When I played the original, I was pretty impressed with the graphics, but they're trash by today's standards. However, the Definitive Edition on the Switch really upped its game, using the same engine that Xenoblade 2 used. It gave this game the upgrade it needed to be, in my mind, one of the best games of all time. Really glad we got our boi Shulk into Smash, and now hopefully we'll get some representation from Xenoblade 2!",
    ...
    },
    {
        ...
        "music": 1.5,
        "visuals": 1.5,
        "review_1": "I was never a huge Animal Crossing fan, but fortunately, my brother bought this one and kinda just mooched off his. It's a pretty okay game, and I can understand why people enjoy the kind of relaxed playstyle, especially during a year like 2020. I did have some fun with the online friend features at the beginning, but the main thing that waned my interest was that it just took too long for new stuff to happen. I played for about a month and then kind of gave up on it, cause it lost the ability to excite me. Not sure I can make a recommendation on whether or not to buy this one though, since I didn't like it much but many many people disagree with me.",
        "review_2": "",
        "img_path": "gameimages/ac.jpg",
        "console_path": "gameimages/nswitch.png"
    },
    {
